...
namespace ntu.xzmcwjzs.WebApp.Common.LuceneHelper
{
    public sealed class IndexManager
    {
        ...
        public Queue<FenCiViewModel> queue = new Queue<FenCiViewModel>();
        /// <summary>
        /// 向队列中添加数据
        /// </summary>
        /// <param name="id"></param>
        ...
        {
            FenCiViewModel viewModel = new FenCiViewModel();
            viewModel.Id = id;
            viewModel.Title = title;
            viewModel.Content = content;
            viewModel.LuceneTypeEnum = Model.Enum.LuceneTypeEnum.Add;
        ...
        public void DeleteQueue(int id)
        {
            FenCiViewModel viewModel = new FenCiViewModel();
            viewModel.Id = id;
            viewModel.LuceneTypeEnum = Model.Enum.LuceneTypeEnum.Delete;
            queue.Enqueue(viewModel);
        }
